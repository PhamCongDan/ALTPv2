...
public class tienThuongLayout extends RelativeLayout {
    private TextView tvLevel[];
    private int width;

    public tienThuongLayout(Context context) {
        super(context);
    ...
    public tienThuongLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        width = context.getResources().getDisplayMetrics().widthPixels;
